...
# iic — REMOVED for LDSDR (no external IIC bus needed)
# In15 already tied to GND in the interrupt section above

# ad9361

# LVDS mode: p/n pairs (6 data pairs DDR = 12 bits/cycle)
