...
![Path X Annotated Waveform](path_x_waveform_annotated.png)

*Annotated waveform with phase bars (RESET / warm-up / TX 16 pairs / FLUSH).
Generated by `render_waveform_clear.py` from the captured `path_x_simple.vcd`.
Original simpler version: `path_x_simple_waveform.png`.*
